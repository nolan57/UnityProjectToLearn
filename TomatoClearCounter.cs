...
public class TomatoClearCounter : BaseCounter//,IKObjInterActions
{
    public static TomatoClearCounter instance
    {
        get;private set;
    }
    ...
    new void Awake()
    {
        ...
        hitedCounterName = "TomatoClearCounterSelected" + InstanceID;
        this.GetTransform().Find("TomatoClearCounterSelected").name = hitedCounterName;
    }
