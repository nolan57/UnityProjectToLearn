...
public class PlatesCounter : BaseCounter//,IKObjInterActions
{
    public static PlatesCounter instance
    {
        get;private set;
    }
    ...
    new void Awake()
    {
        ...
        hitedCounterName = "PlatesCounterSelected" + InstanceID;
        this.GetTransform().Find("PlatesCounterSelected").name = hitedCounterName;
    }
