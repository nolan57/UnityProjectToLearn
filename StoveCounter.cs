...
public class StoveCounter : BaseCounter//,IKObjInterActions
{
    ...
    new void Awake()
    {
        ...
        hitedCounterName = "StoveCounterSelected" + InstanceID;
        this.GetTransform().Find("StoveCounterSelected").name = hitedCounterName;
    }
